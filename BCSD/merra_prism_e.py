...
from bias_c import BiasCorrectDaily, convert_to_float32

parser = argparse.ArgumentParser()
parser.add_argument("fobserved", help="Netcdf file containing an upscaled version of the observed dataset", type=str)
...
f_observed = 'data2/ghana_upscaled.nc'
f_modeled = 'data2/chirps_filled.nc'
obs_var = 'precip'
modeled_var = 'pr'
